...
4. Compile the project with your C++ compiler. For example, if you're using g++, you might use `g++ -o maze_solver main.cpp`.
5. Run the compiled program with `./maze_solver`.

## Testing

Tests are located in the `test_Maze.cpp` file. Run them with your preferred C++ testing framework.
